    ...
    <div className="max-w-2xl mx-auto px-6 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          ...
          className="text-left p-6 rounded-xl border border-gray-200 bg-white hover:border-gray-900 transition-all duration-300 animate-fade-up"
        >
              ...
              {!isLoadingInterpretation && (
                <div className="mt-6">
                  <button
                    ...
                    className="bg-gray-900 text-white font-ui text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-gray-800 transition-colors"
                  >
            ...
            <div className="mt-10 pt-10 border-t border-gray-200 max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-gray-900 text-white font-ui text-sm font-medium px-5 py-3 rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isLoadingResult ? "Synthesizing…" : uiCopy.diagnosticCTA}
                </button>
                <button className="flex-1 border border-gray-900 text-gray-900 font-ui text-sm font-medium px-5 py-3 rounded-lg hover:bg-gray-100 transition-colors">
      ...
      {showPhase1Bar && (
        <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 px-6 py-4 flex justify-between items-center animate-fade-up">
          ...
          <button
            ...
            className="bg-gray-900 text-white font-ui text-sm font-medium px-6 py-2 hover:bg-gray-700 transition-colors rounded"
          >
      ...
      {showPhase2Bar && (
        <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 px-6 py-4 flex justify-between items-center animate-fade-up">
          ...
          <button
            ...
            className="bg-gray-900 text-white font-ui text-sm font-medium px-6 py-2 hover:bg-gray-700 transition-colors rounded disabled:opacity-40 disabled:cursor-not-allowed"
          >
