      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <div className="divide-y divide-gray-100">
          ...
          <section className="pb-16">
            ...
            <h2 className="font-display text-2xl md:text-3xl text-charcoal mb-8">It Kept Showing Up</h2>
          ...
          <section className="pt-16">
            ...
            <h2 className="font-display text-2xl md:text-3xl text-charcoal mb-8">Not a Framework to Learn</h2>
            <p className="font-ui text-base text-gray-600 leading-relaxed mb-5">
