...
Gallup's research on strengths-based feedback finds that employees who receive meaningful feedback regularly are substantially more engaged and substantially less likely to leave. In a study of 65,672 employees, those who received regular strengths-based feedback showed turnover rates 14.9% lower than employees who received no feedback. Separate Gallup studies found that work units whose managers received strengths feedback showed 12.5% greater productivity, across a sample of 530 work units, and 8.9% greater profitability, across a sample of 469 business units, compared to units without it. The direction of causality here is worth noting: it is not just that better teams get more feedback. It is that feedback, delivered consistently, produces better teams.

The frequency effect is significant on its own. Gallup's research on feedback cadence, reported in its analysis "How Fast Feedback Fuels Performance," finds that employees whose managers provide daily feedback, as opposed to annual, are 3.6 times more likely to agree they are motivated to do outstanding work, and that 80% of employees who received meaningful feedback in the past week describe themselves as fully engaged. These are not marginal effects. They suggest that the cadence of honest exchange is itself a performance variable, independent of the content of any individual conversation.

The implication is that candor is not just a retention tool or a morale variable. It is a strategic condition. Organizations that suppress it are not just making their people miserable, they are making themselves slower, less adaptive, and less capable of acting on accurate information.
...
## How Candor Degrades: What the Candor Discount Actually Measures
...
*Lateral candor failure* occurs when peers and cross-functional partners stop sharing accurate information with each other. Departments learn, through experience, that sharing problems with adjacent teams generates more friction than managing them internally. What crosses departmental lines becomes progressively more curated, more positive, and less useful. This is the primary driver of Silosolation, not organizational structure, but the candor discount applied horizontally. Organizations with degraded lateral candor are, almost by definition, organizations where information stops moving across the boundaries that matter most, which is a slower, less adaptive way to operate regardless of what any single study measures.
