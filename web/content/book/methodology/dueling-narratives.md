...
## What Happens the Moment This Becomes External

Internally, dueling narratives are uncomfortable but survivable. People pick a version, navigate around the ambiguity, muddle through.

The moment this touches litigation, an investigation, or any process involving discovery, the exposure changes completely. An inconsistency that was merely awkward internally becomes a documented contradiction when examined by anyone with subpoena power or cross-examination skill. Two authoritative accounts of the same event that don't match each other turn a defensible position into an indefensible one. Not because the underlying facts were necessarily damaging. Because the organization can be shown, in its own words, to disagree with itself about what those facts were.
...
**Nobody with the standing to reconcile them has done so.** The condition persists because no one has confirmed one account, corrected the other, or produced a third version that resolves the contradiction.

---

## Why Restating the Official Version Doesn't Work

Leadership's instinct is to restate the official version more firmly and treat that as resolution. It isn't. Restating one account doesn't address why the other exists or why people with real standing are still circulating it. The contradiction doesn't disappear because one side spoke more confidently. It just goes quieter, until the next moment someone has to choose which version to repeat.
...
Controlling how that reconciliation happens is a very different position than having it forced on you later.
