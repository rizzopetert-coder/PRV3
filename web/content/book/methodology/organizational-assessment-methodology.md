...
People Tactics & Strategy is built on three principles that correct for this.
...
**It tells you what it found, not what you want to hear.** Most assessments are conducted by people with something to protect. The consultant wants the next engagement. The internal team member wants to keep their job. The trusted advisor wants to remain trusted. In every case, the incentive to soften the findings is stronger than the incentive to name them accurately. The result is a diagnosis that has already been edited before it reaches the people who need the raw truth most. People Tactics & Strategy has no such incentive. What was found is what gets reported.
...
Most assessments go cleanly. Some don't, and the difference between a methodology that holds up and one that doesn't shows up exactly there.

If the leader who commissioned the engagement turns out to be part of what's wrong, the findings don't get softer. They get more carefully framed — naming behavior and its consequences, not character — because a diagnosis someone can't hear is useless, and one that protects their comfort instead of telling the truth isn't honest either.

If the organization is in active crisis, the temptation is to move faster than the investigation can honestly go. People Tactics & Strategy doesn't compress the sequence to match the urgency. A diagnosis reached quickly under pressure isn't better than one reached carefully. It's just faster, and more likely to be wrong.

And sometimes the finding is that there isn't one. The investigation turns up friction within normal range, nothing that rises to a diagnosis. The report says so — clearly, without hedging, and without manufacturing significance to justify the engagement. A clean bill of organizational health is a real finding. It gets treated as one.
...
People Tactics & Strategy exists for the organizations that have decided to do it differently.
