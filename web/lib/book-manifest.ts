...
export const bookManifest: BookPiece[] = [
  ...
  },
  {
    ...
    teaser: "Everyone already knows this person shouldn't still be on the team. The conversations have happened more than once. One-on-one conversations, hallway asides, and even performance reviews — though not on paper. The personnel file describes one employee. The conversations describe a completely different one.",
    author: "Principal Resolution",
    status: "published",
    contentPillar: "Reframe",
    primaryDimension: "aptitude",
  ...
  },
  {
    ...
    teaser: "There's a safety concern in the organization right now. It could be physical safety, psychological safety, or operational safety. People know about it. It hasn't been formally reported. The silence is a separate finding from the hazard itself, and it's the one that will produce the next hazard nobody reports either.",
    author: "Principal Resolution",
    status: "published",
    contentPillar: "Reframe",
    primaryDimension: "attitude",
  ...
  },
  {
    ...
    teaser: "Most organizations document defensively and starve the documentation that actually protects people (such as the performance conversation, the commitment, and the disagreement). The paper that creates real risk isn't the paper you're missing. It's the paper you didn't need.",
