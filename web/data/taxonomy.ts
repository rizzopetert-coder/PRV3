...
export const signatures: Signature[] = [
  {
    ...
    coexistenceInterpretation:
      "What makes this pattern distinct is what happens when several leadership failures are present at once. Concentrated authority produces a bottleneck. Compromised oversight means legitimate issues disappear along the escalation path. Strategic analysis gets done and then gets ignored, so major people decisions get made without the evidence that was already available. The official structure and the real one have separated far enough that fixing the official one won't solve anything. These conditions protect each other when they coexist. The organization can address any one of them and find the others still in place, still producing the same results. That's the signature. That's what has to be read whole.",
  },
  {
    id: "culture_erosion",
    ...
    coexistenceInterpretation:
      "What makes this pattern dangerous is the sequence it follows. The culture gradually drifts without a single decision anyone can point to. Then the reward system starts reflecting the new reality instead of the stated values, and the people paying attention adjust their behavior accordingly. Then the official story stops matching the lived experience. Then credibility burns across the accumulated weight of unfulfilled commitments. Two different organizations have emerged — the one in the office and the one working remotely. Different leaders, different behaviors, different directions, and no shared account of what this place actually is. And when a disruptive change arrives without enough of a plan, the erosion accelerates. The result: the employees most capable of adapting are the ones most able to leave. By the time the organization recognizes what's happened, the people most capable of reversing it have already left. Culture erosion at this stage isn't a morale problem. It's a dangerous structural condition.",
  },
  {
    id: "stunted_growth",
    name: "Stunted Growth",
    ...
    coexistenceInterpretation:
      "What makes this signature distinct from a general talent problem is where the failure is actually located. Not in the people themselves, but distributed across the conditions surrounding them. The manager who isn't developing anyone may be genuinely incapable, structurally prevented, or simply disengaged. Those three conditions look identical from where the team sits but require completely different responses. When they appear together, the organization is losing on multiple fronts simultaneously. The talent pipeline isn't being built, the people currently in leadership are operating below capacity, the roles designed to carry growth aren't structured to do it, and the people absorbing all of it are burning out quietly rather than saying so. The organization reads this as a talent problem and goes looking for better people. The conditions that produced it are still in place when they arrive.",
  },
  {
    ...
    coexistenceInterpretation:
      "What changes when these conditions appear together is the story they tell in combination. A single compliance failure is an incident. A pattern of them across multiple domains over time, with documentation that contradicts the witness accounts, is evidence of a culture of non-compliance. That is what plaintiffs' attorneys, regulators, and journalists are trained to find. The organization isn't being evaluated on whether it made mistakes. It's being evaluated on whether it knew, whether it acted, and whether the gap between those two things was a choice. A sequence of individually defensible decisions can still add up to retaliation despite the absence of intention. A manager's performance judgment can be accurate and the personnel file can still be legally indefensible, because important conversations never made it onto paper. A pay structure can drift into compression through ordinary hiring decisions and still leave the organization exposed the moment transparency requirements force it into view. None of that intent-free exposure is smaller than exposure from a more deliberate failure. It is often larger, because the absence of intent removes the one defense the organization would otherwise have while the pattern itself proves it should have known better.",
  },
  {
