"""
PRV3 -- apply the Tier 3 no-ai-slop fix for the-untouchable.md
...
(C:\\Users\\rizzo\\Downloads\\the-untouchable.md, landed 2026-08-17
21:57): zero mojibake, raw em-dash count exactly 9 as claimed. Diffed
line-by-line against live (--strip-trailing-cr): all 3 changes are pure
punctuation conversions (em-dash to colon or comma), no wording or
content changes anywhere. No named claims in this file requiring
citation verification. Signature line untouched.

Usage:
  python tools/patch_no_ai_slop_tier3_the_untouchable.py --dry-run
  python tools/patch_no_ai_slop_tier3_the_untouchable.py --write
"""
...
SRC = Path(r"C:\Users\rizzo\Downloads\the-untouchable.md")
LIVE = REPO_ROOT / "web/content/book/methodology/the-untouchable.md"
