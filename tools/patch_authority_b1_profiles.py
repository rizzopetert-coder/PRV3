#!/usr/bin/env python
"""
PRV3 — patch_authority_b1_profiles.py
Creates engine/test_profiles_authority_b1.py with 18 Authority Phase 1 test profiles.
...
Session locked design decisions:
  - AUT-HC-01: principal_role = "HR leader" (HR is the presenting principal in this scenario)
  - AUT-HI-03: cross-dimension co-signal (heard_and_ignored + the_paper_tiger) — intentional
  - AUT-UP-03: single_state at Entrenched at weak signal — prior claim specificity; no pass_criterion override
  - AUT-HC-03, AUT-TV-03, AUT-HI-03: pass_criterion = "top_3" (doc specifies top-2; maps to nearest valid value)

Usage:
  python tools/patch_authority_b1_profiles.py --dry-run
  python tools/patch_authority_b1_profiles.py --write
"""
import argparse
import sys
from pathlib import Path

TARGET = Path(__file__).parents[1] / "engine" / "test_profiles_authority_b1.py"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Create engine/test_profiles_authority_b1.py"
    )
    parser.add_argument(
