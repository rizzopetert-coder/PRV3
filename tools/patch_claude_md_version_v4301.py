...
v4.300 -> v4.301, matching this session's built_to_fail drift correction
(tools/_mob.txt).

Usage:
    python tools/patch_claude_md_version_v4301.py --dry-run
    python tools/patch_claude_md_version_v4301.py --write
"""
import argparse
import pathlib
import sys
...
VERSION_OLD = '| MOB version | v4.300 |'
VERSION_NEW = '| MOB version | v4.301 |'

EDITS = [
    ('MOB version cross-reference 4.300 -> 4.301', VERSION_OLD, VERSION_NEW),
]
