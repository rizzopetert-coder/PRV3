...
v4.298 -> v4.299, matching this session's Phase 2b (OH) closeout
(tools/_mob.txt).

Usage:
    python tools/patch_claude_md_version_v4299.py --dry-run
    python tools/patch_claude_md_version_v4299.py --write
"""
import argparse
import pathlib
import sys
...
VERSION_OLD = '| MOB version | v4.298 |'
VERSION_NEW = '| MOB version | v4.299 |'

EDITS = [
    ('MOB version cross-reference 4.298 -> 4.299', VERSION_OLD, VERSION_NEW),
]
