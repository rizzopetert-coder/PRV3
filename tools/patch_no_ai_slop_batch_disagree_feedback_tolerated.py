...
of the open queue:
  ...
  why-your-team-stopped-disagreeing-with-you.md  12 -> 8
  feedback-nobody-wants-to-say.md                11 -> 8
  the-tolerated-violation.md                     11 -> 8
...
Downloads as a zip (C:\\Users\\rizzo\\Downloads\\files112\\, extracted
2026-08-17 22:47): zero mojibake in any of the three, em-dash count
exactly 8 in each, as claimed.

Diffed line-by-line against live for all three (--strip-trailing-cr):
feedback-nobody-wants-to-say.md (3 changes), the-tolerated-violation.md
(3 changes), and why-your-team-stopped-disagreeing-with-you.md (4
changes) are each pure punctuation conversions (em-dash to colon or
comma), no wording or content changes anywhere. No named claims in any
of the three requiring citation verification.

Usage:
  python tools/patch_no_ai_slop_batch_disagree_feedback_tolerated.py --dry-run
  python tools/patch_no_ai_slop_batch_disagree_feedback_tolerated.py --write
"""
...
SRC_DIR = Path(r"C:\Users\rizzo\Downloads\files112")

FILES = [
    ("feedback-nobody-wants-to-say.md", REPO_ROOT / "web/content/book/memo/feedback-nobody-wants-to-say.md"),
    ("the-tolerated-violation.md", REPO_ROOT / "web/content/book/methodology/the-tolerated-violation.md"),
    ("why-your-team-stopped-disagreeing-with-you.md", REPO_ROOT / "web/content/book/memo/why-your-team-stopped-disagreeing-with-you.md"),
]
