...
v4.302 -> v4.303, matching this session's closeout (tools/_mob.txt).

Usage:
    python tools/patch_claude_md_version_v4303.py --dry-run
    python tools/patch_claude_md_version_v4303.py --write
"""
import argparse
import pathlib
import sys
...
VERSION_OLD = '| MOB version | v4.302 |'
VERSION_NEW = '| MOB version | v4.303 |'

EDITS = [
    ('MOB version cross-reference 4.302 -> 4.303', VERSION_OLD, VERSION_NEW),
]
