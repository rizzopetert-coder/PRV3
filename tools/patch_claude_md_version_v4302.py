...
v4.301 -> v4.302, matching this session's closeout (tools/_mob.txt).

Usage:
    python tools/patch_claude_md_version_v4302.py --dry-run
    python tools/patch_claude_md_version_v4302.py --write
"""
import argparse
import pathlib
import sys
...
VERSION_OLD = '| MOB version | v4.301 |'
VERSION_NEW = '| MOB version | v4.302 |'

EDITS = [
    ('MOB version cross-reference 4.301 -> 4.302', VERSION_OLD, VERSION_NEW),
]
