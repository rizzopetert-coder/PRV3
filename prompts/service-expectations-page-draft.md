...
gives those things their best chance.

## What We Stand Behind But Cannot Guarantee

The diagnostic names a real condition, not a hypothesis. We stand behind its accuracy the same
way a doctor stands behind a diagnosis: confident in the read, honest that the patient still has
...
Not exhaustive. Organized by service so it's clear which team does which work, and to match the
four sections already live on this page.

**The diagnostic itself**
- Run the diagnostic and name the condition precisely, not generically.
- Tell you what we see, in plain language, including the parts that are hard to hear.
- Recommend the resolution path that actually fits the condition, not the one that's easiest to
  sell.
- Put our reasoning in writing so it survives past the conversation.

**People Tactics and Strategy**
- Assess your organizational structure, roles, and decision rights against how work actually
...
- Design leadership development around the specific gap the diagnostic identified, not a
  standing curriculum.
- Work one-on-one with a leader on a named behavior, until it changes.
- Run team-building work aimed at a diagnosed trust or collaboration failure, not a generic
  offsite.
- Deliver skills training built for the actual gap in front of us.

**Intervention**
- Go into a live, unresolved situation directly, in the room, not advising from outside it.
- Mediate an active conflict between leaders or teams while there's still room to shape the
  outcome.
...
- Hold a standing, confidential relationship with a leader for the decisions they can't discuss
  inside the building.
- Serve as the outside read before a high-stakes call, not after.
- Stay available on an ongoing basis, not just for a single engagement.

## What We Don't Do

Also not exhaustive, and organized the same way. A few items apply across every service rather
...
**People Tactics and Strategy**
- We don't restructure before diagnosing what's actually broken.
- We don't hand over a slide deck and leave your team to implement it alone.
- We don't do compliance-only HR paperwork with no strategic layer behind it.
...
- We don't do teambuilding that's designed to have happened rather than to change anything.

**Intervention**
- We don't take a side in interpersonal politics that isn't the diagnosed issue.
- We don't show up as a generic firefighter without diagnostic grounding first.
- We don't substitute for legal counsel once a situation carries real legal exposure.
...
what's shipped. Worth a read-through against the four existing service sections above it on the
page once it's placed, to make sure nothing here contradicts or duplicates what's already said
there rather than complementing it.]
...
- Once you've filled in the bracketed items, this is ready for the attorney-adjacent review this
  ...
  weight) before it goes to CC for placement in /about/services.
